...
namespace Rekabsen
{
    public class BodyConfigurationLocal : MonoBehaviour, BodyConfigurationInterface
    {
        ...
        [SerializeField] private float torsoLengthMax = 0.66f;
        [SerializeField] private float rotoBallRadius = 0.2f;
        [SerializeField] private float anchorOriginHeight = 0.25f;
        [SerializeField] private float crouchSpeed = 1f;
        [SerializeField] private float jumpDepth = -0.6f;
        [SerializeField] private float turnSpeed = 120f;
        [SerializeField] private float nerdNeckMin = 0.125f;
        ...
        private float virtualCrouch;
        private float jumpCrouch;
        private float turn;
        ...
        private void PhysicsHead()
        {
            ...
            headRotation = Quaternion.Euler(0f, turn, 0f) *
            ...
            headCamera.rotation = headRotation;
